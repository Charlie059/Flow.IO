...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      entities: [Credential, ServiceName, CredentialType],
      synchronize: process.env.TYPEORM_SYNC === 'true', // TODO: disable this in production
    }),
    TypeOrmModule.forFeature([Credential, ServiceName, CredentialType]),
  ],
